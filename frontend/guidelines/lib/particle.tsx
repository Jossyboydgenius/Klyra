...
import { coreDao, coreTestnet1, kairos, solana, baseSepolia, sepolia, base } from '@particle-network/connectkit/chains';
...
'Segoe UI Symbol'`,
  ...
  chains: [coreDao, kairos, coreTestnet1, solana, baseSepolia, sepolia, base],
});
